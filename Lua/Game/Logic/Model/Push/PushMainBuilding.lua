PushMainBuilding = Clone(PushBase)
PushMainBuilding.__cname = "PushMainBuilding"

function PushMainBuilding:OnInit()

end

function PushMainBuilding:Available()
    return self:IsMaxCity()
end

---@param now Time2
function PushMainBuilding:GenerateData(now)
