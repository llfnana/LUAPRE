---@class MutualDialogue : IStoryBase
MutualDialogue = Clone(IStoryBase)
MutualDialogue.__cname = "MutualDialogue"
MutualDialogue.type = EnumStoryType.MutualDialogue

function MutualDialogue:PrepareInputs()
    MainUI.Instance:SetMainUIState(false)
end

function MutualDialogue:OnExecuteSelf()
    ...
    TutorialHelper.ShowDialog(params)
end

return MutualDialogue